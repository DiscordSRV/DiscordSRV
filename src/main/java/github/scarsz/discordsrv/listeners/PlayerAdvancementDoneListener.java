...
public class PlayerAdvancementDoneListener implements Listener {
    ...
    public void onPlayerAdvancementDone(PlayerAdvancementDoneEvent event) {
        ...
        AchievementMessagePreProcessEvent preEvent = DiscordSRV.api.callEvent(new AchievementMessagePreProcessEvent(channelName, message, player, advancement, advancementName, false));
        ...
        advancementName = preEvent.getAdvancementName();
        ...
        AchievementMessagePostProcessEvent postEvent = DiscordSRV.api.callEvent(new AchievementMessagePostProcessEvent(channelName, message, player, advancement, advancementName, false));
