 ...
 */
public class LegacyVentureChatMessagePreProcessEvent extends LegacyVentureChatMessageEvent implements Cancellable {
    ...
    public LegacyVentureChatMessagePreProcessEvent(String channel, Component message, VentureChatEvent ventureChatEvent) {
    ...
    @Deprecated
    public LegacyVentureChatMessagePreProcessEvent(String channel, String message, VentureChatEvent ventureChatEvent) {
