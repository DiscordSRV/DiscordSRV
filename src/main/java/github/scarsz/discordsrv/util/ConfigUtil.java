...
public class ConfigUtil {
    ...
    public static void migrate() {
        Version configVersion = DiscordSRV.config().getString("ConfigVersion").split("\\.").length == 2 ? Version.valueOf(DiscordSRV.config().getString("ConfigVersion")) : Version.valueOf("1." + DiscordSRV.config().getString("ConfigVersion"));
