        ...
        ASM_WARNING(new HashMap<Language, String>() {{
           ...
           put(Language.KO,
            ...
            put(Language.TR,
                    "\n" +
                    "\n" +
                    "DiscordSRV'yi ASM 4 üzerinde kullanmaya çalışıyorsunuz fakat DiscordSRV ASM 5 gerektiriyor.\n" +
                    "DiscordSRV ASM 5 olmadan ÇALIŞMAYACAKTIR. Süresi geçmiş kütüphaneler kullandıkları için sunucu yazılımınızın geliştiricisini suçlayabilirsiniz.\n" +
                    "\n" +
                    "ASM 5'e güncelleme adımları:\n" +
                    "1. Sunucunun {specialsourcefolder} klasörüne girin\n" +
                    "2. SpecialSource-1.7-SNAPSHOT.jar dosyasını silin\n" +
                    "3. https://repo1.maven.org/maven2/net/md-5/SpecialSource/1.7.4/SpecialSource-1.7.4.jar adresinden SpecialSource v1.7.4'ü indirin\n" +
                    "4. Jar dosyasını daha önce açtığnız {specialsourcefolder} klasörüne kopyalayın\n" +
                    "5. Az önce kopyaladığınız jar dosyasının adını SpecialSource-1.7-SNAPSHOT.jar olarak değiştirin\n" +
            ...
            put(Language.TR,
                    "\n" +
                    "\n" +
                    "RespectChatPlugins devre dışı, bu seçenek SADECE TEST İÇİNDİR\n" +
                    "ve ASLA son kullanıcı sunucularında devre dışı olmamalıdır.\n" +
                    "Bu seçeneği devre dışı bırakmak, iptal edilen mesajların Discord'a yönlendirmesine sebep olacaktır\n" +
                    "/ komutları kullanmayan özel mesajlar, yetkili özel sohbet mesajları ve daha fazlası buna dahildir.\n" +
                    "\n" +
                    "\n");
            ...
            put(Language.TR, "Kullanıcı tecrübeniz {client} kullandığınızdan ötürü kalitesiz olacaktır, bazı komutlar beklendiği gibi çalışmayabilir.");
            ...
            put(Language.TR, "Konsol yönlendirmesi kanala yönlendirildi");
            ...
            put(Language.TR, "Konsol kanal ID'si geçeli değil, konsol çıktısı yönlendirilmeyecektir.");
            ...
            put(Language.TR, "Sunucu {ms}ms içinde başarıyla kapatıldı.");
            ...
            put(Language.TR, "API dinleyici {listenername} abone oldu ({methodcount} metod)");
            ...
            put(Language.TR, "API dinleyici {listenername} abonelikten ayrıldı");
            ...
            put(Language.TR, "DiscordSRV API Dinleyicisi {listenername} yöntemi {methodname}, erişilebilir hale getirme çabalarına rağmen erişilemedi");
            ...
            put(Language.TR, "URL alımı başarısız oldu");
            ...
            put(Language.TR, "URL indirmesi başarısız oldu");
            ...
            put(Language.TR, "{plugin} kancası etkinleştiriliyor");
            ...
            put(Language.TR, "Hiçbir sohbet eklenti kancası etkinleştirilmedi");
            ...
            put(Language.TR, "Sohbet etkinliği iptal algılayıcısı etkinleştirildi");
            ...
            put(Language.TR, "Bot herhangi bir Discord sunucusunun parçası değildir. Kurulum talimatlarını takip edin");
            ...
            put(Language.TR, "Konsol kanalı, sohbet için kullanılan bir kanala atandı. Kanal ID'si konfigürasyon seçeneğine körü körüne bir ID mi kopyala/yapıştır yaptınız?");
            ...
            put(Language.TR, "Konsol eylemi kaydedilirken hata oluştu");
            ...
            put(Language.TR, "{player} oyuncusu sessiz katılma izniyle katıldı, katılma mesajı gönderilmeyecektir");
            ...
            put(Language.TR, "{player} oyuncusu sessiz çıkma izniyle çıkıyor, çıkış mesajı gönderilmeyecektir");
            ...
            put(Language.TR, "Bağlı hesaplar {ms}ms içinde kaydedildi");
            ...
            put(Language.TR, "Bağlı hesaplar kaydedilirken bir sorun meydana geldi");
            ...
            put(Language.TR, "Plugin yüklenirken bir hata meydana geldi");
            ...
            put(Language.TR, "Grup senkronizasyonunda kullanılacak {rolename} rol ID'si bulunamadı. Bot sunucuda mı?");
            ...
            put(Language.TR, "Yayınlanacak bir metin verilmedi");
            ...
            put(Language.TR, "Sadece oyuncular bu komutu kullanabilir.");
            ...
            put(Language.TR, "DiscordSRV konfigürasyonu ve dili yeniden yüklendi.");
            ...
            put(Language.TR, "Hiçbir oyuncu belirtilmedi. Bu bir oyuncu UUID'si, oyuncu adı, veya bir Discord ID'si olabilir.");
            ...
            put(Language.TR, "Komutunuz işlenirken dahili bir hata meydana geldi.");
            ...
            put(Language.TR, "Grup senkronizasyonu, synchronization.yml dosyasında geçerli GroupRoleSynchronizationGroupsAndRolesToSync girişlerini gerektirir");
