    ...
    public enum InternalMessage {
        ...
        ASM_WARNING(new HashMap<Language, String>() {{
           ...
           put(Language.KO,
            ...
            put(Language.RU, "Спасибо огромное всем этим людям, которые помогли DiscordSRV стать тем, чем он есть");
            put(Language.ET, "Suur tänu neile inimestele, kes aitasid DiscordSRV-l kasvada selleks, mis see täna on");
