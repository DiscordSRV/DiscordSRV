    ...
    public enum InternalMessage {
        ...
        ASM_WARNING(new HashMap<Language, String>() {{
           ...
           put(Language.KO,
            ...
            put(Language.IT, "Trovato server");
            ...
            put(Language.IT, "ID canale della console non è valido, non inoltrare l'uscita della console");
            ...
            put(Language.IT, "API listener {listenername} sottoscritta ({methodcount} methods)");
            ...
            put(Language.IT, "API listener {listenername} annullato");
            ...
            put(Language.IT, "Ascoltatore API DiscordSRV. {listenername} metodo {methodname}era inaccessibile nonostante gli sforzi per renderlo accessibile");
            ...
            put(Language.IT, "Impossibile recuperare URL");
            ...
            put(Language.IT, "Abilitazione {plugin} gancio");
            ...
            put(Language.IT, "Nessun gancio per plug-in chat abilitato");
            ...
            put(Language.IT, "Il rilevatore di cancellazione dell'evento chat è stato abilitato");
            ...
            put(Language.IT, "Errore nell'azione della console di registrazione a");
            ...
            put(Language.IT, "Player {player} è entrato con il permesso di unione silenzioso, non invio di un messaggio di join");
            ...
            put(Language.IT, "Giocatore {player} è uscito con il permesso di chiuso silenzioso, non invio di un messaggio di chiuso");
            ...
            put(Language.IT, "Nessun testo dato alla trasmissione");
            ...
            put(Language.IT, "La sincronizzazione del gruppo richiede valida GroupRoleSynchronizationGroupsAndRolesToSync Voci in synchronization.yml");
